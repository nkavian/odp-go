...
func main() {
	...
	var mixed directory.SearchSequence[directory.Result] = directoryClient.Search(context.Background(), directory.DirectorySearchRequest{
		SearchRequest: directory.SearchRequest{Filters: &directory.ServiceFilters{Sources: []directory.SourceType{directory.SourceOpenAPI}}},
